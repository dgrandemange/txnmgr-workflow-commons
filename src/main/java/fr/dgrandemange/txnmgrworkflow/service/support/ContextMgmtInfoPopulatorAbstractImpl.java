...
public abstract class ContextMgmtInfoPopulatorAbstractImpl implements
	...
	/* (non-Javadoc)
	 * @see fr.dgrandemange.txnmgrworkflow.service.IContextMgmtInfoPopulator#processParticipantAnnotations(java.util.Map)
	 */
	abstract public void processParticipantAnnotations(
			Map<String, List<ParticipantInfo>> txnMgrGroups);

	/* (non-Javadoc)
	 * @see fr.dgrandemange.txnmgrworkflow.service.IContextMgmtInfoPopulator#updateReducedGraph(fr.dgrandemange.txnmgrworkflow.model.Graph)
	 */
	...
	protected void updateReducedGraphTransitionsWithContextMgmtInfo(
			Graph graph, fr.dgrandemange.txnmgrworkflow.model.Node currentNode) {
		if (null == graph) {
			return;
		}
