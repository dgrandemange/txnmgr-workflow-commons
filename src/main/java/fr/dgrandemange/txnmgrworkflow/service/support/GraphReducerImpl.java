...
import fr.dgrandemange.txnmgrworkflow.service.IGraphReducer;

/**
 * Base implementation of graph reducer service<br>
 * It mutualizes common paths, starting from the final node.<br>  
 * 
 * @author dgrandemange
 * 
 */
public class GraphReducerImpl implements IGraphReducer {
	...
	/* (non-Javadoc)
	 * @see fr.dgrandemange.txnmgrworkflow.service.IGraphReducer#reduce(fr.dgrandemange.txnmgrworkflow.model.Graph)
	 */
