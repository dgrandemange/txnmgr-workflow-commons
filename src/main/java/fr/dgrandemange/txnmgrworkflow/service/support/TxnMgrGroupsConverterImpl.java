...
import fr.dgrandemange.txnmgrworkflow.model.NodeWrapper;
...
import fr.dgrandemange.txnmgrworkflow.service.ITxnMgrGroupsConverter;
...
public class TxnMgrGroupsConverterImpl implements ITxnMgrGroupsConverter {
	 ...
	 * 
	 * @see
	 * fr.dgrandemange.txnmgrworkflow.service.ITxnMgrGroupsConverter#toGraph(
	 * java.util.Map)
	 */
